...
{
    internal class AutomaticCompensationCutHeightViewModel : CustomBindableBase
    {
        private readonly IRegionManager _regionManager;
        private int _id;
        private bool _look;

        private AutomaticCompensationCutHeightEntity _automaticCompensationCutHeightEntity;

        public AutomaticCompensationCutHeightEntity Entity
        {
            get { return _automaticCompensationCutHeightEntity; }
            set { SetProperty(ref _automaticCompensationCutHeightEntity, value); }
        }

        public AutomaticCompensationCutHeightViewModel(IRegionManager regionManager)
        {
        ...
        public override async void OnNavigatedTo(NavigationContext navigationContext)
        {
            ...
            Entity = await SqlHelper.GetOrCreateEntityAsync(() => new AutomaticCompensationCutHeightEntity());
        }
